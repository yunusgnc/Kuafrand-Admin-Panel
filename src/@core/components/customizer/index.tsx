      ...
      >
        ...
        <div className={classnames('customizer-header flex items-center justify-between', styles.header)}>
          ...
          <div className='flex gap-4'>
            <div onClick={settings.resetSettings} className='relative flex cursor-pointer'>
              <i className='ri-refresh-line text-actionActive' />
              <div className={classnames(styles.dotStyles, { [styles.show]: settings.isSettingsChanged })} />
            </div>
            ...
            <div className='layout-section flex flex-col gap-6'>
              ...
              {!disableDirection && (
                <div className='flex flex-col gap-2'>
                  ...
                  <div className='flex items-center gap-4'>
                    <Link href={getLocalePath(pathName, 'tr')}>
                      <div className='flex flex-col items-start gap-0.5'>
                        <div
                          className={classnames(styles.itemWrapper, {
