...
const CustomThemeProvider = (props: Props) => {
  // Props
  const { children, direction: propDirection, systemMode } = props
  ...
  // Use i18n direction if available, otherwise fallback to prop direction
  const direction = i18nDirection || propDirection
